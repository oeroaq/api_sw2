...
class UniversidadsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create universidad" do
    assert_difference('Universidad.count') do
      post universidads_url, params: { universidad: { nombre: @universidad.nombre, rector: @universidad.rector, telefono: @universidad.telefono } }
    end
  ...
  test "should update universidad" do
    patch universidad_url(@universidad), params: { universidad: { nombre: @universidad.nombre, rector: @universidad.rector, telefono: @universidad.telefono } }
